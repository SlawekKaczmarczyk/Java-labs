...
public class Document {
    ...
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
        ...
        doc.setTitle("Sławomir Kaczmarczyk");
        doc.setPhoto("src/tiger.jpg");
        ...
        doc.addSection("Wyształcenie").addParagraph(new ParagraphWithList().setContent("")
                .addListItem("Szkoła Podstwowa w Klimontowie")
                .addListItem("Gimnazium w Klimontowie")
                .addListItem("LO w Sandomierzu")
